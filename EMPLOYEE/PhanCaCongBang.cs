...
namespace QuanLyHotel.EMPLOYEE
{
    internal class PhanCaCongBang
    {
        ...
        public PhanCaCongBang(int sql, int stt, int slc, int s1, int s2, int s3, int c1, int c2, int c3, DateTime bd, int st) : this()
        {
            so_quan_li = sql;
            so_tiep_tan = stt;
            so_lao_cong = slc;
